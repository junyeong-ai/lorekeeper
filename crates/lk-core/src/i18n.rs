...
pub struct Strings {
    ...
    pub tasks_someday: &'static str,
    /// Title of the daily page a completed task is archived onto.
    pub tasks_archive_title: &'static str,
    pub agenda_due: &'static str,
    pub agenda_overdue: &'static str,
    /// Suffix on a carry count, as `3{agenda_day}`.
    pub agenda_day: &'static str,
    pub agenda_done_today: &'static str,
...
static KO: Strings = Strings {
    ...
    status_board_unplaceable: "이 도구가 닿지 못하는 할 일 — lore agenda 가 줄과 이유를 말합니다",
};
...
static EN: Strings = Strings {
    ...
    tasks_someday: "Someday",
    tasks_archive_title: "Completed",
    agenda_due: "due",
    ...
    status_board_unplaceable: "a task no rule can reach — `lore agenda` names the line and why",
};
